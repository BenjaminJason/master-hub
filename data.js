...
const SCHOOL_DEADLINES={
  ...
  // ── 日本 ──
  "东京大学":      [{prog:"GSII英文硕士（信息/AI）",month:11,day:10,note:"秋季入学，提前联系教授"},{prog:"MERIT工学英文项目",month:12,day:15}],
  "京都大学":      [{prog:"英文工学/信息学（秋入学）",month:10,day:15,note:"需提前内诺导师"}],
  "东京工业大学":  [{prog:"ACLS英文CS/AI项目",month:11,day:30},{prog:"一般英文硕士",month:12,day:15}],
  "大阪大学":      [{prog:"E-cube工程英文项目",month:10,day:31,note:"秋季入学"}],
  "东北大学":      [{prog:"AIM材料/工学英文项目",month:10,day:31,note:"秋季入学，仙台生活成本低"}],
  // ── 韩国 ──
  "首尔国立大学":  [{prog:"英文CS/理工（秋入学）",month:4,day:15,note:"申请截止，竞争激烈"},{prog:"GSB商科（秋入学）",month:4,day:30}],
  "延世大学":      [{prog:"英文CS/金融工程（秋入学）",month:3,day:31}],
  "高丽大学":      [{prog:"英文CS/MBA（秋入学）",month:4,day:30}],
  "浦项科技大学":  [{prog:"CS/AI研究型（春入学）",month:1,day:31,note:"POSTECH春入学1月截止"},{prog:"秋入学",month:4,day:30}],
  // ── 德国补充 ──
  ...
  // ── 法国 ──
  "巴黎文理研究大学":[{prog:"AI/ML（ENS/CentraleSupélec）",month:3,day:15,note:"第一轮，竞争极高"},{prog:"延期/第二轮",month:3,day:31}],
  "索邦大学":      [{prog:"CS/数学项目（第一轮）",month:3,day:31},{prog:"第二轮滚动",month:4,day:30}],
  "巴黎综合理工学院":[{prog:"Mathematics & AI（IP Paris）",month:3,day:15,note:"名额极少"}],
  "巴黎-萨克雷大学":[{prog:"M2数学/CS/AI（第一轮）",month:3,day:15},{prog:"第二轮",month:3,day:31}],
  // ── 瑞典 ──
